webpackJsonp([2,3],Array(18).concat([
/* 18 */
	...
	exports.default = {
	  ...
	  computed: {
	    userIcon: function userIcon() {
	      ...
	      return 'url(' + __webpack_require__(52)("./" + icon) + ')';
	    },
